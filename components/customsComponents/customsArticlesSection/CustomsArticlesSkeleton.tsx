// components/customsComponents/customsArticlesSection/CustomsArticlesSkeleton.tsx
import { SectionTitle } from "@/components/sectionTitle/SectionTitle";

export function CustomsArticlesSkeleton() {
  return (
    <section className="py-20" id="customs-stories">
