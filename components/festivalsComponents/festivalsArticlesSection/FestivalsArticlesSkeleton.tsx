// components/festivalsComponents/festivalsArticlesSection/FestivalsArticlesSkeleton.tsx
import { SectionTitle } from "@/components/sectionTitle/SectionTitle";

export function FestivalsArticlesSkeleton() {
  return (
    <section className="py-20" id="festivals-stories">
