        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-[30%] flex-shrink-0">
            <div
              ...
              style={{
                top: "0.5rem", // ページ上部からの距離をさらに短く
                paddingTop: "2rem", // メインコンテンツとの調整
                maxHeight: "calc(100vh - 1rem)", // 画面の高さをほぼフルに使用
                overflowY: "auto", // 内容が多い場合はスクロール可能
                paddingBottom: "2rem", // 下部の余白を追加
              }}
            >
              <RelatedArticles
