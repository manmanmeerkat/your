...
export default function RootLayout({
  ...
  return (
    <html lang="ja" suppressHydrationWarning>
      <head>
        {/* ✅ Supabase への接続を先に張って初回を速くする */}
        <link rel="preconnect" href="https://nprutgcfqaovdxlzjoaa.supabase.co" />
        <link rel="dns-prefetch" href="https://nprutgcfqaovdxlzjoaa.supabase.co" />
